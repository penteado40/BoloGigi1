                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form method="POST" action="">
                                    ...
                                    <?php echo "<a href='list_cliente.php' class='btn  btn-primary'>Voltar</a>
                                    <a href='edit_cliente.php?EmailCliente=".$EmailCliente."' class='btn  btn-primary'>Editar</a>
                                    <a href='del_cliente.php?EmailCliente=".$EmailCliente."' data-confirm='Tem certeza de que deseja excluir o item selecionado?' class='btn  btn-primary'>Excluir</a>
                                    "?>
                            </div>
                            <div class="col-md-6">
