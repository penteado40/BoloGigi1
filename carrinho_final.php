        	...
        	<div class="col-sm-12">
				<div class="card">
					<div class="card-header">
                        <?php  echo" <h5 class='card-title'>Pedido referente a: $NomeCompleto</h5> ";?>
                    </div>
                    <div class="card-body">
						<?php 
                            ...
                            <hr>
                            <a href='cancel_pedido.php' data-confirm='Tem certeza de que deseja cancelar o pedido?' class='btn btn-primary'>Cancelar</a>
                            <a href='carrinho.php?ID_Pedido=".$ID_Pedido."' class='btn  btn-primary'>Editar Pedido</a>
                            <a href='finish_pedido.php?ID_Pedido=".$ID_Pedido."&ValorFinal=".$ValorFinal."' data-confirm='Tem certeza de que deseja excluir o item selecionado?' class='btn  btn-primary'>Finalizar Compra</a>
