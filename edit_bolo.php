...
<head>
    <?php
        ...
        $sql = "SELECT * FROM bolos WHERE ID_Bolo = '$ID_Bolo'";
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form method="POST" action="res_editbolo.php">
                                    <div class="form-group">
                                        <label>ID Bolo</label>
                                        <input type="text" class="form-control" readonly="true" name="ID_Bolo" value="<?php echo $ID_Bolo ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Sabor</label>
